...
#Region " Visible "
    ...
    ''' The associated <see cref="Control"/> used to perform draggable operations.
    ''' </summary>
    Private WithEvents _Parentctrl As Control = Nothing
...
#Region " Constructors "
    ...
    Public Sub New(ByVal ctrl As Control, Optional ByVal Parrentctrl As Control = Nothing)
        Me._Parentctrl = Parrentctrl
        Me._ctrl = ctrl
    End Sub
...
#Region " Event Handlers "
    ...
    Private Sub _ctrl_MouseHover(sender As Object, e As EventArgs) Handles _ctrl.MouseHover
        Me.oldCursor = Me._ctrl.Cursor
...
#Region " Private Methods "
    ...
    Private Sub SetActiveEdge(ByVal e As MouseEventArgs)
        If Not (Me._Parentctrl Is Nothing) Then
            ...
            Select Case True
                ...
                Case e.X <= (Me.PixelMargin * 2) AndAlso
                    ...
                    ' TopRight Corner
                Case e.X > Me._Parentctrl.Width - (Me.PixelMargin * 2) AndAlso
                     e.Y <= (Me.PixelMargin * 2)
                    ...
                    ' Bottom-Left Corner
                Case (e.X <= Me.PixelMargin * 2) AndAlso
                     (e.Y > Me._Parentctrl.Height - (Me.PixelMargin * 2))

                    Me.ActiveEdge = Edges.BottomLeft

                    ' Bottom-Right Corner
                Case (e.X > Me._Parentctrl.Width - (Me.PixelMargin * 2) - 1) AndAlso
                     (e.Y > Me._Parentctrl.Height - (Me.PixelMargin * 2))
                ...
                Case e.X <= Me.PixelMargin
                    ...
                    ' Right Edge
                Case e.X > Me._Parentctrl.Width - (Me.PixelMargin + 1)
                ...
                Case e.Y <= Me.PixelMargin
                    ...
                    ' Bottom Edge
                Case e.Y > Me._Parentctrl.Height - (Me.PixelMargin + 1)
    ...
    Private Sub SetControlBounds(ByVal e As MouseEventArgs)
        ...
        If Not (Me._Parentctrl Is Nothing) Then
            ...
            If Me._Parentctrl.Size.Width = Me._Parentctrl.MinimumSize.Width Then
                ' Exit Sub
            Else
                Debug.WriteLine(Me._Parentctrl.Size.ToString)
            End If

            Me._Parentctrl.SuspendLayout()

            Select Case Me.ActiveEdge

                Case Edges.Left
                    If Not Me._Parentctrl.Width - e.X < (Me._Parentctrl.MinimumSize.Width) Then
                        Me._Parentctrl.SetBounds(x:=Me._Parentctrl.Left + e.X,
                                           y:=Me._Parentctrl.Top,
                                           width:=Me._Parentctrl.Width - e.X,
                                           height:=Me._Parentctrl.Height)
                    End If

                Case Edges.Right
                    Me._Parentctrl.SetBounds(x:=Me._Parentctrl.Left,
                                       y:=Me._Parentctrl.Top,
                                       width:=Me._Parentctrl.Width - (Me._Parentctrl.Width - e.X),
                                       height:=Me._Parentctrl.Height)

                Case Edges.Top
                    If Not Me._Parentctrl.Height - e.Y < (Me._Parentctrl.MinimumSize.Height) Then
                        Me._Parentctrl.SetBounds(x:=Me._Parentctrl.Left,
                                           y:=Me._Parentctrl.Top + e.Y,
                                           width:=Me._Parentctrl.Width,
                                           height:=Me._Parentctrl.Height - e.Y)
                    End If
                ...
                Case Edges.Bottom
                    Me._Parentctrl.SetBounds(x:=Me._Parentctrl.Left,
                                       y:=Me._Parentctrl.Top,
                                       width:=Me._Parentctrl.Width,
                                       height:=Me._Parentctrl.Height - (Me._Parentctrl.Height - e.Y))

                Case Edges.TopLeft
                    Me._Parentctrl.SetBounds(x:=If(Not Me._Parentctrl.Width - e.X < (Me._Parentctrl.MinimumSize.Width),
                                            Me._Parentctrl.Left + e.X,
                                             Me._Parentctrl.Left),
                                       y:=If(Not Me._Parentctrl.Height - e.Y < (Me._Parentctrl.MinimumSize.Height),
                                             Me._Parentctrl.Top + e.Y,
                                             Me._Parentctrl.Top),
                                       width:=If(Not Me._Parentctrl.Width - e.X < (Me._Parentctrl.MinimumSize.Width),
                                                 Me._Parentctrl.Width - e.X,
                                                 Me._Parentctrl.Width),
                                       height:=If(Not Me._Parentctrl.Height - e.Y < (Me._Parentctrl.MinimumSize.Height),
                                                  Me._Parentctrl.Height - e.Y,
                                                  Me._Parentctrl.Height))
